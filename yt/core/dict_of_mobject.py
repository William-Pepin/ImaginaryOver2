...
class DictOfMobject():
    def __init__(self, keys: Sequence[Mobject], values: Sequence[Mobject], headers: Sequence[Mobject], v_buff=0.4, h_buff=1):
        ...
        self.table = MobjectTable(keys_values, arrange_in_grid_config={"cell_alignment": LEFT}, include_outer_lines=True, line_config={
                                  "stroke_width": 3, "color": cf.DARK_GREY}, col_labels=headers, v_buff=v_buff, h_buff=h_buff)
